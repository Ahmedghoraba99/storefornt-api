...
var productFunction = new products_1.productsFunctions();
var user = {
    id: 1,
    fname: 'test',
    lname: 'user',
...
describe('Products functions not throwing errs', function () {
    ...
    it('Create works without type err', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            expect(function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
...
describe('Products functions definition testing.....', function () {
...
describe('sucess acess without token testing.....', function () {
    it(' sucess to get /products/id without bearer token', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, req.get('/products/1').send({ id: 1 })];
                case 1:
                    response = _a.sent();
    ...
    it(' sucess to POST /products/ without bearer token', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, req.post('/products/').send(product)];
                case 1:
                    response = _a.sent();
...
describe('acess granted with token testing.....', function () {
    it(' sucess to GET /products with bearer token', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it(' sucess to POST /products/ with bearer token', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, req
